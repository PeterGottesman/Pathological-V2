...
public:
    ...
    RenderRequest(RenderStatus status, int width, int height, int framesPerSecond, int animationRuntime,
                  int framesCompleted, int executionTime, int samplesPerPixel, const std::string &sceneFileUrl,
                  const std::string &createdAt, const std::string &outputFileName);
