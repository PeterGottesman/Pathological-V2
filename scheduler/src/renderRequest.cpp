...
RenderRequest::RenderRequest(RenderStatus status, int width, int height, int framesPerSecond, int animationRuntime,
                             int framesCompleted, int executionTime, int samplesPerPixel,
...
int RenderRequest::getAnimationRuntimeInFrames() const { return this->animationRuntime; }

int RenderRequest::getFramesCompleted() const { return this->framesCompleted; }

const std::string &RenderRequest::getSceneFileUrl() const { return this->sceneFileUrl; }
...
const std::vector<std::string> &RenderRequest::getDownloadLinks() const { return this->downloadLinks; }
...
RenderRequest &RenderRequest::setDownloadLink(const std::optional<std::string> &link) {
    this->downloadLink = link;
    return *this;
}

RenderRequest &RenderRequest::setDownloadLinks(const std::vector<std::string> &links) {
