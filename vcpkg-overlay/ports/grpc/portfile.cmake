# Local copy of vcpkg's grpc 1.71.0#3 port (baseline e7b52424) that skips
# targets this project never links, to cut build time: grpc_unsecure,
# grpc++_unsecure, grpc_authorization_provider (via 00018-optional-unused-libs
# .patch) and the non-C++ protoc plugins. Re-diff against the upstream port
# whenever vcpkg-configuration.json's baseline is bumped.
...
vcpkg_from_github(
    ...
    PATCHES
        ...
        00018-optional-unused-libs.patch
)
file(REMOVE_RECURSE
